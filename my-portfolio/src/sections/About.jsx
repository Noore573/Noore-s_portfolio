...
const About = () => {
    return (
        <section
            id="about"
            className="min-h-screen flex flex-col md:flex-row items-center justify-center gap-10 px-6 md:px-16 text-white bg-hero-gradient"
        >
            {/* LEFT SIDE */}
            <div className="flex flex-col items-center text-center md:w-1/3">
                ...
                />
                <h2 className="text-lg font-semibold">@NooreAlsadoon</h2>
                <a
                    href="/resume.pdf"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="mt-4 px-6 py-2 rounded-full bg-cyan-400 text-blue-900 font-semibold hover:bg-cyan-300 transition"
                >
                    View CV
                </a>
            </div>
            ...
            <div className="flex flex-col gap-6 md:w-2/3">
                {/* Panel 1 - Bio */}
                <div className="bg-glass-gradient backdrop-blur-lg p-6 md:p-8 rounded-xl shadow-lg">
                    <h3 className="text-2xl font-bold mb-4">
                        HELLO I’M <span className="text-cyan-400">NOORE SABAH</span>
                    </h3>
                    <p className="text-gray-100 leading-relaxed">
                        ...
                        With 3 years of experience, I focus on building fast, responsive web
                ...
                {/* Panel 2 - Contact */}
                <div className="bg-glass-gradient backdrop-blur-lg p-6 rounded-xl shadow-lg flex flex-col items-center">
