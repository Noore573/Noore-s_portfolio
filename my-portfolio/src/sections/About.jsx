...
const About = () => {
    return (
        <section
            id="about"
            className="min-h-screen flex flex-col md:flex-row items-center justify-center gap-10 px-6 md:px-16 text-white  relative"
        >
            {/* LEFT SIDE */}
            ...
            <div className="flex flex-col gap-6 md:w-2/3 h-2/3">
                {/* Panel 1 - Bio */}
                <div className="bg-glass-gradient animate-glass-diagonal   tracking-wide font-robotoFlex backdrop-blur-lg p-6 h-96 md:p-8 rounded-xl shadow-lg hover:scale-105 transition delay-100">
                    <h3 className="text-4xl font-bold mb-4 font-righteous">
                ...
                {/* Panel 2 - Contact */}
                <div className="bg-glass-gradient  animate-glass-diagonal hover:scale-105 transition delay-100  tracking-wide font-robotoFlex backdrop-blur-lg p-6 rounded-xl shadow-lg flex flex-col items-center">
